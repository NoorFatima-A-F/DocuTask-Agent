...
export class ApdlePlannerApiClient {
    ...
    static async getGraph(missionId = 'default_mission') {
        try {
    ...
    static async getCriticalPath(missionId = 'default_mission') {
        try {
    ...
    static async getSchedule(missionId = 'default_mission') {
        try {
    ...
    static async getSimulation(missionId = 'default_mission', numTrials = 100) {
        try {
    ...
    static async triggerReplan(missionId = 'default_mission', failedNodeId, errorReason = 'Validation invariant breached', confidenceDrop) {
        try {
    ...
    static async getMutations(missionId = 'default_mission') {
        try {
    ...
    static getFallbackGraph(missionId) {
        return {
            dag_id: 'dag-init',
            mission_id: missionId,
            generation: 1,
