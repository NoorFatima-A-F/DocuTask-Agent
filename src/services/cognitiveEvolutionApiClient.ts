...
import {
  SynthesizedStrategyRecordPayload,
  MutationResultPayload,
  PlannerGenerationPayload,
  EvolutionCycleReportPayload,
  DigitalTwinClusterReportPayload,
  CausalNodePayload,
  InterventionResultPayload,
  DeliberationSessionSummaryPayload,
} from '../types/cognitiveEvolution';
...
export class CognitiveEvolutionApiClient {
  ...
  public static async synthesizeStrategy(goalIntent: string = 'extract_financial_invoice'): Promise<SynthesizedStrategyRecordPayload> {
    try {
      return await this.request<SynthesizedStrategyRecordPayload>('/strategy/synthesize', {
        method: 'POST',
  ...
  public static async mutateStrategy(mutationType: string = 'OPERATOR_SWAP'): Promise<MutationResultPayload> {
    try {
      return await this.request<MutationResultPayload>('/strategy/mutate', {
        method: 'POST',
  ...
  public static async evolvePlanner(weakness: string): Promise<EvolutionCycleReportPayload> {
    try {
      return await this.request<EvolutionCycleReportPayload>('/planner/evolve', {
        method: 'POST',
  ...
  public static async listPlannerGenerations(): Promise<PlannerGenerationPayload[]> {
    try {
      return await this.request<PlannerGenerationPayload[]>('/planner/generations');
    } catch {
      return [
        {
  ...
  public static async runDigitalTwinSimulation(missionCount: number = 500): Promise<DigitalTwinClusterReportPayload> {
    try {
      return await this.request<DigitalTwinClusterReportPayload>('/simulation/run', {
        method: 'POST',
  ...
  public static async getCausalModel(): Promise<CausalNodePayload[]> {
    try {
      return await this.request<CausalNodePayload[]>('/causal/model');
    } catch {
      return [
  ...
  public static async executeDoIntervention(treatmentVal: number = 8.0): Promise<InterventionResultPayload> {
    try {
      return await this.request<InterventionResultPayload>('/causal/intervene', {
        method: 'POST',
  ...
  public static async conveneCouncilDeliberation(missionId: string = 'mission_delib_001'): Promise<DeliberationSessionSummaryPayload> {
    try {
      return await this.request<DeliberationSessionSummaryPayload>('/deliberation/session', {
        method: 'POST',
