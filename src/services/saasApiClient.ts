...
export class SaaSApiClient {
  static async getExecutiveOverview(): Promise<SaaSExecutiveOverview> {
    try {
  ...
  static async listOrganizations(tenant_id?: string): Promise<OrganizationNode[]> {
    try {
  ...
  static async getOrganizationTree(tenant_id: string): Promise<OrganizationNode[]> {
    try {
  ...
  static async listWorkspaces(tenant_id?: string): Promise<Workspace[]> {
    try {
  ...
  static async listProjects(tenant_id?: string): Promise<Project[]> {
    try {
  ...
  static async listSSOConfigs(tenant_id?: string): Promise<SSOProviderConfig[]> {
    try {
  ...
  static async listUsers(tenant_id?: string): Promise<UserIdentity[]> {
    try {
  ...
  static async listInvoices(tenant_id?: string): Promise<Invoice[]> {
    try {
  ...
  static async listUsageRecords(tenant_id?: string): Promise<UsageRecord[]> {
    try {
  ...
  static async listLicenses(tenant_id?: string): Promise<LicenseKey[]> {
    try {
  ...
  static async listMarketplaceAssets(): Promise<MarketplaceAsset[]> {
    try {
  ...
  static async installAsset(asset_id: string, tenant_id: string): Promise<any> {
    const res = await fetch(`${BASE_URL}/marketplace/assets/${asset_id}/install?tenant_id=${tenant_id}`, {
      method: 'POST',
    });
    if (!res.ok) throw new Error('Failed to install asset');
    return await res.json();
  }

  static async listIntegrations(tenant_id?: string): Promise<ConnectorConfig[]> {
    try {
  ...
  static async testConnector(connector_id: string): Promise<any> {
  ...
  static async listPolicies(tenant_id?: string): Promise<TenantPolicy[]> {
    try {
  ...
  static async listAuditEvents(tenant_id?: string): Promise<AuditEvent[]> {
    try {
  ...
  static async verifyAuditIntegrity(tenant_id: string): Promise<any> {
    const res = await fetch(`${BASE_URL}/audit/verify/${tenant_id}`);
    if (!res.ok) throw new Error('Audit verification failed');
    return await res.json();
  }

  static async getBranding(tenant_id: string): Promise<BrandingConfig> {
    try {
