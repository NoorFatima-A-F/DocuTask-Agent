...
import {
  FlameGraphNodePayload,
  MissionTimelineItemPayload,
  RuntimeDashboardStatePayload,
  RuntimeHealthScorePayload,
...
export class RuntimeObservabilityApiClient {
  ...
  static async getDashboard(): Promise<RuntimeDashboardStatePayload> {
    try {
  ...
  static async getHealth(): Promise<RuntimeHealthScorePayload> {
    try {
  ...
  static async getTimeline(missionId: string = 'default_mission'): Promise<MissionTimelineItemPayload[]> {
    try {
  ...
  static async getProfile(missionId: string = 'default_mission'): Promise<{
    mission_id: string;
  ...
  private static getFallbackDashboard(): RuntimeDashboardStatePayload {
