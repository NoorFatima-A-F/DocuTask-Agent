...
import type {
  ...
  ReplayBookmark,
  ReplaySpeed,
} from '../types/esmrReplay';

const API_BASE = '/api/v1/replay';

export class EsmrReplayApiClient {
  static async getReplayState(missionId: string): Promise<ReplaySessionState> {
    try {
  ...
  static async seek(missionId: string, targetIndex: number): Promise<ReplaySessionState> {
    try {
  ...
  static async stepForward(missionId: string): Promise<ReplaySessionState> {
    try {
  ...
  static async stepBackward(missionId: string): Promise<ReplaySessionState> {
    try {
  ...
  static async setSpeed(missionId: string, speed: ReplaySpeed): Promise<{ speed: ReplaySpeed }> {
    try {
  ...
  static async getTimeline(missionId: string): Promise<TimelineSummary> {
    try {
  ...
  static async getDecisionGraph(missionId: string): Promise<DecisionGraph> {
    try {
  ...
  static async getDecisions(missionId: string): Promise<DecisionRecord[]> {
    try {
  ...
  static async getAuditTrail(missionId: string): Promise<AuditRecord[]> {
    try {
  ...
  static async verifyAudit(missionId: string): Promise<AuditVerificationReport> {
    try {
  ...
  static async getSnapshots(missionId: string): Promise<SnapshotMetadata[]> {
    try {
  ...
  static async getBookmarks(missionId: string): Promise<ReplayBookmark[]> {
    try {
  ...
  // --- Mock Fallbacks ---
  private static getMockReplayState(missionId: string): ReplaySessionState {
    return {
      mission_id: missionId,
      status: 'PAUSED',
      speed: '1x',
  ...
  private static getMockTimeline(missionId: string): TimelineSummary {
    return {
      mission_id: missionId,
      total_events: 10,
  ...
  private static getMockDecisionGraph(missionId: string): DecisionGraph {
    return {
      mission_id: missionId,
  ...
  private static getMockDecisions(missionId: string): DecisionRecord[] {
    return [
      {
  ...
  private static getMockAuditTrail(missionId: string): AuditRecord[] {
    return [
      {
