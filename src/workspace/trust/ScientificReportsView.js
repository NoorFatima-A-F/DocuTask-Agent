...
export const ScientificReportsView = () => {
...
**Official Seal:** \`0x8f2ac31b4e5d6a7b2c0894e38087434f\``;
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-border/40 pb-4", children: [_jsxs("div", { children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("h1", { className: "text-2xl font-bold tracking-tight", children: "Scientific Mission Reports" }), _jsx(Badge, { variant: "intelligence", size: "sm", children: "Pillar 10" })] }), _jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Automated generation of audit dossiers incorporating decision proofs, evidence trees, trust scores, and replay attestations." })] }), _jsx("div", { className: "flex items-center gap-2", children: _jsxs("button", { onClick: () => setSelectedFormat(selectedFormat === 'MARKDOWN' ? 'JSON' : 'MARKDOWN'), className: "text-xs px-3 py-1.5 rounded bg-muted hover:bg-muted/80 text-foreground transition-colors font-medium font-mono", children: ["Format: ", selectedFormat] }) })] }), _jsx(Card, { className: "p-5 border-border/60 bg-muted/5 font-mono text-xs overflow-x-auto whitespace-pre-wrap leading-relaxed", children: selectedFormat === 'MARKDOWN' ? reportMarkdown : JSON.stringify({ mission_id: 'msn_1001', trust_score: 98.4, tier: 'ENTERPRISE_HIGHEST_ASSURANCE' }, null, 2) })] }));
};
