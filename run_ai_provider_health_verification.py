...
def main():
    ...
    conn_rep = results["connectivity_report"]
    lat_rep = results["latency_report"]
    quota_rep = results["quota_report"]
    integ_rep = results["integrity_report"]
    timeout_rep = results["timeout_report"]
    fail_rep = results["failure_report"]
    deg_rep = results["degraded_report"]
    failover_rep = results["failover_report"]
    mon_rep = results["monitoring_report"]
